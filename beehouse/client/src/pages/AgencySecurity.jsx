          ...
          <div className=" p-6 bg-white  md:mt-0 sm:max-w-md  sm:p-8">
            ...
            >
              <div>
                <label
                  htmlFor="oldPassword"
                  className="block mb-2 text-sm ml-5 sm:ml-[0px] font-medium text-gray-900 "
                >
                  Old Password
                </label>
                <input
                  type="password"
                  id="oldPassword"
                  className="bg-gray-50 border border-gray-700 ml-[20px] sm:ml-[0px] w-[280px] sm:w-[350px]  text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5  dark:border-gray-600 dark:placeholder-gray-400  dark:focus:ring-blue-500 dark:focus:border-blue-500"
                  value={oldPassword}
                  placeholder="••••••••"
              ...
              <div>
                ...
                <input
                  type="password"
                  id="password"
                  className="bg-gray-50 border border-gray-300 ml-[20px] sm:ml-[0px] w-[280px] sm:w-[350px]  text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 0 dark:border-gray-600 dark:placeholder-gray-400  dark:focus:ring-blue-500 dark:focus:border-blue-500"
                  placeholder="••••••••"
                  value={newPassword}
              ...
              <div>
                <label
                  ...
                  className="block mb-2 text-sm font-medium ml-5 sm:ml-[0px] text-gray-900 "
                >
