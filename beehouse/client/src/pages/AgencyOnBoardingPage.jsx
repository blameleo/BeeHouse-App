    ...
    <div className="bg-black font-volkhorn  ">
      ...
      >
        <div>
          ...
          <br />
          <input
            className={`border px-3 mb-3 outline-none mt-1 w-[300px] sm:[400px]  md:w-[500px] h-14 rounded-lg ${
          ...
          <br />
          <textarea
            className={`border px-3 outline-none mt-1  w-[300px] sm:[400px] md:w-[500px] h-14 rounded-lg ${
