      ...
      {loading ? (
        ...
        <div className="flex flex-wrap sm:px-8 mt-20 ">
          {jobs.map((job) => {
            ...
            return (
              <div className=" h-[20%] w-[250px] ml-[20px] sm:ml-[20px] mr-5 border border-gray-700 shadow-xl rounded-[20px] bg-white hover:scale-105 transition duration-500  mb-10">
                <div
